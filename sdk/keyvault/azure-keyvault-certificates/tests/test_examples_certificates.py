...
class TestExamplesKeyVault(CertificatesTestCase, KeyVaultTestCase):
    ...
    def test_example_certificate_backup_restore(self, certificate_client, **kwargs):
        ...
        if self.is_live:
            time.sleep(60)
            certificate_client.begin_create_certificate("livekvtestpurge1", policy=cert_policy).wait()
            time.sleep(60)
            certificate_client.begin_create_certificate("livekvtestpurge2", policy=cert_policy).wait()
            time.sleep(60)
            certificate_client.begin_create_certificate("livekvtestpurge3", policy=cert_policy).wait()
